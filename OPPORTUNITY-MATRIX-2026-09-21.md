...
| --- | --- | --- | --- | --- |
| 1 | [RevenueCat Shipaton 2026](https://revenuecat-shipaton-2026.devpost.com/rules) | Sep 30, 2026 11:45pm PDT; Devpost advertises US$740,000 cash across categories | ProofPocket already has a local Android prototype, a verified 1179×2556 screenshot, a paywall concept, and a successful public CI run | A qualifying first public store release, RevenueCat premium access/test path, public ≤2-minute video, submission fields, and owner eligibility/identity review |
...
The official rules require a working mobile application using RevenueCat, a
